...
class TestReDeploymentServer(unittest.TestCase):
    @patch("multi_x_serverless.deployment.server.re_deployment_server.Endpoints")
    ...
    def test_run(self, mock_update_workflow_placement_decision, mock_run_deployer):
        ...
        self.mock_endpoints.return_value.get_deployment_algorithm_update_checker_client.return_value = mock_client
    ...
    @patch("multi_x_serverless.deployment.server.re_deployment_server.create_default_deployer")
    @patch("multi_x_serverless.deployment.server.re_deployment_server.DeployerFactory")
