...
class TestLogSyncer(unittest.TestCase):
    @patch("multi_x_serverless.syncers.log_syncer.Endpoints")
    ...
    @patch("multi_x_serverless.syncers.log_syncer.Endpoints")
    @patch("multi_x_serverless.syncers.log_syncer.LogSyncWorkflow")
    @patch("multi_x_serverless.syncers.log_syncer.LogSyncer._get_time_intervals_to_sync", return_value=["interval1"])
    ...
    @patch("multi_x_serverless.syncers.log_syncer.datetime")
