...
class TestPerformanceLoader(unittest.TestCase):
    ...
    @patch(
        "multi_x_serverless.routing.solver.input.components.loaders.performance_loader.PerformanceLoader._retrieve_region_data"
    )
    ...
    def test_get_transmission_latency(self):
        result = self.loader.get_transmission_latency("aws:region1", "aws:region2", 100, False)
