...
class DataCenterRegionLoader(Loader):
    ...
    def setup(self, regions: list[(str, str)]) -> bool:
        ...
        self._data = {
            "compute_cost": {}, # "PLACEHOLDER: loaded dictionary ((region_provider, region_name): *****Compute cost list(this need to be treated differently as providers scale cost base on calls))", dict(str, list[(float, int)])
