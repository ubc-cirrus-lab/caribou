    ...
    def get_cpu_utilization(self, instance) -> float:
        if self.get_small_or_large() == "small":
            ...
            data = {
                ...
                "text_2_speech_censoring-0_0_1-Text2Speech:text_2_speech_censoring-0_0_1-GetInput_0_0:1": 0.10565184626978147,
                "text_2_speech_censoring-0_0_1-Profanity:text_2_speech_censoring-0_0_1-GetInput_0_1:2": 0.35193841077811383,
                "text_2_speech_censoring-0_0_1-Conversion:text_2_speech_censoring-0_0_1-Text2Speech_1_0:3": 0.3153414988582105,
                "text_2_speech_censoring-0_0_1-Censor:sync:": 0.5025715297562728,
                "text_2_speech_censoring-0_0_1-Compression:text_2_speech_censoring-0_0_1-Conversion_3_0:5": 0.3111135075502209,
