...
class TestDeploymentOptimizationMonitor(unittest.TestCase):
    @patch("caribou.monitors.deployment_optimization_monitor.WorkflowCollector")
    ...
    @patch("caribou.monitors.deployment_optimization_monitor.datetime")
    @patch("caribou.monitors.deployment_optimization_monitor.WorkflowConfig")
