            ...
            "PriceLists": [
                {
                    ...
                    "PriceListArn": "arn",
                    "PriceList": {
                        "products": {"product1": {"sku": "sku1", "attributes": {"usagetype": "ReadCapacity"}}},
                        "terms": {
                            "OnDemand": {"sku1": {"priceDimensions": {"dimension1": {"pricePerUnit": {"USD": "0.5"}}}}}
                        },
                    },
                }
            ]
            ...
            "PriceLists": [
                {
                    ...
                    "PriceListArn": "arn",
                    "PriceList": {
                        "products": {"product1": {"sku": "sku1", "attributes": {"usagetype": "storage"}}},
                        "terms": {
                            "OnDemand": {"sku1": {"priceDimensions": {"dimension1": {"pricePerUnit": {"USD": "0.5"}}}}}
                        },
                    },
