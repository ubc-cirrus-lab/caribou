...
class TestDeployerFactory(unittest.TestCase):
    @mock.patch("caribou.deployment.common.factories.deployer_factory.yaml.safe_load")
    @mock.patch(
        "builtins.open",
    ...
    @mock.patch("caribou.deployment.common.factories.deployer_factory.DeployerFactory.load_project_config")
    @mock.patch("caribou.deployment.common.factories.deployer_factory.DeployerFactory.load_workflow_app")
    ...
    @mock.patch("caribou.deployment.common.factories.deployer_factory.create_default_deployer")
